                          ...
                          <div class="col-md-3 col-xs-12">
                              <div class="large-catalog-inner-block block-3">
                                  ...
                                  <div class="block-footer center">
                                      ...
                                      <?php } else {  ?>
                                          <a href="<?php echo base_url('en/dashboard/purchase/paypal/products/2') ?>" class="cool-button cool-button-3 form-submitter">Promote-Rank Using Paypal</a>
                          ...
                          <div class="col-md-3 col-xs-12">
                              <div class="large-catalog-inner-block block-3">
                                  ...
                                  <div class="block-footer center">
                                      ...
                                      <?php } else {  ?>
                                          <a href="<?php echo base_url('en/dashboard/purchase/paypal/products/3') ?>" class="cool-button cool-button-3 form-submitter">Double Coins Using Paypal</a>
                          ...
                          <div class="col-md-3 col-xs-12">
                              <div class="large-catalog-inner-block block-3">
                                  ...
                                  <div class="block-footer center">
                                      ...
                                      <?php } else {  ?>
                                          <a href="<?php echo base_url('en/dashboard/purchase/paypal/products/4') ?>" class="cool-button cool-button-3 form-submitter">AFK Varification Using Paypal </a>
